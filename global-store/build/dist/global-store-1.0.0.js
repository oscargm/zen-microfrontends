(function webpackUniversalModuleDefinition(root, factory) {
	...
	//CommonJS Export
		...
		exports["global-store"] = factory();
	//Root Export
	else
		root["global-store"] = factory();
})(window, function() {
...
var DESCRIPTORS = __webpack_require__(5);
var definePropertyModule = __webpack_require__(4);
...
var sharedKey = __webpack_require__(17);
...
var DESCRIPTORS = __webpack_require__(5);
var objectDefinePropertyModile = __webpack_require__(4);
...
var path = __webpack_require__(44);
var has = __webpack_require__(2);
var wrappedWellKnownSymbolModule = __webpack_require__(49);
var defineProperty = __webpack_require__(4).f;
...
var IS_PURE = __webpack_require__(18);
var Iterators = __webpack_require__(14);
var IteratorsCore = __webpack_require__(60);
...
var getOwnPropertyNamesModule = __webpack_require__(30);
var getOwnPropertyNamesExternal = __webpack_require__(72);
var getOwnPropertySymbolsModule = __webpack_require__(46);
var getOwnPropertyDescriptorModule = __webpack_require__(24);
var definePropertyModule = __webpack_require__(4);
var propertyIsEnumerableModule = __webpack_require__(37);
...
var toIndexedObject = __webpack_require__(10);
var nativeGetOwnPropertyNames = __webpack_require__(30).f;
...
var ArrayIteratorMethods = __webpack_require__(58);
var createNonEnumerableProperty = __webpack_require__(9);
var wellKnownSymbol = __webpack_require__(0);
...
var es_symbol = __webpack_require__(69);
...
var es_array_concat = __webpack_require__(76);
...
var es_array_is_array = __webpack_require__(86);

// EXTERNAL MODULE: ../node_modules/core-js/modules/es.array.iterator.js
var es_array_iterator = __webpack_require__(58);

// EXTERNAL MODULE: ../node_modules/core-js/modules/es.date.to-string.js
var es_date_to_string = __webpack_require__(92);

// EXTERNAL MODULE: ../node_modules/core-js/modules/es.object.to-string.js
var es_object_to_string = __webpack_require__(93);

// EXTERNAL MODULE: ../node_modules/core-js/modules/es.regexp.to-string.js
var es_regexp_to_string = __webpack_require__(95);
...
// CONCATENATED MODULE: ./emitter.ts
...
// CONCATENATED MODULE: ./global.data.ts


function global_data_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function global_data_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var global_data_GlobalData = function GlobalData(initialValue) {
  var _this = this;

  global_data_classCallCheck(this, GlobalData);

  global_data_defineProperty(this, "data", void 0);

  global_data_defineProperty(this, "emitter", void 0);

  global_data_defineProperty(this, "get", function () {
    return _this.data;
  });

  global_data_defineProperty(this, "set", function (value) {
    _this.data = typeof value === "function" ? value(_this.data) : value;

    _this.emitter.emit(EventIds.change, _this.data);
  });

  global_data_defineProperty(this, "subscribe", function (callback, context) {
    _this.emitter.on(EventIds.change, callback, context);
  });

  global_data_defineProperty(this, "unsubscribe", function (callback) {
...
// CONCATENATED MODULE: ./global.store.ts
