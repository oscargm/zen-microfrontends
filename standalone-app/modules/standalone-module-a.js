(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["standalone-module"] = factory();
	else
		root["StandaloneModule"] = factory();
})(window, function() {
...
var sharedKey = __webpack_require__(15);
...
var IS_PURE = __webpack_require__(16);
var Iterators = __webpack_require__(34);
var IteratorsCore = __webpack_require__(54);
...
*/
var aa=__webpack_require__(0),n=__webpack_require__(36),q=__webpack_require__(60);function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));var ba=null,ca={};
...
var IteratorPrototype = __webpack_require__(54).IteratorPrototype;
var create = __webpack_require__(32);
var createPropertyDescriptor = __webpack_require__(13);
var setToStringTag = __webpack_require__(33);
var Iterators = __webpack_require__(34);
...
var ArrayIteratorMethods = __webpack_require__(52);
var createNonEnumerableProperty = __webpack_require__(6);
var wellKnownSymbol = __webpack_require__(3);
...
var es_symbol = __webpack_require__(62);
...
var es_array_is_array = __webpack_require__(78);

// EXTERNAL MODULE: ../node_modules/core-js/modules/es.array.iterator.js
var es_array_iterator = __webpack_require__(52);

// EXTERNAL MODULE: ../node_modules/core-js/modules/es.date.to-string.js
var es_date_to_string = __webpack_require__(84);

// EXTERNAL MODULE: ../node_modules/core-js/modules/es.object.to-string.js
var es_object_to_string = __webpack_require__(85);

// EXTERNAL MODULE: ../node_modules/core-js/modules/es.regexp.to-string.js
var es_regexp_to_string = __webpack_require__(88);
...
// CONCATENATED MODULE: ./common/providers/global-text/global-text.context.ts

var GetGlobalTextContext = react["createContext"](undefined);
var SetGlobalTextContext = react["createContext"](undefined);
// CONCATENATED MODULE: ./common/providers/global-text/global-text.provider.tsx
...
var global_text_provider_GlobalTextProvider = function GlobalTextProvider(_ref) {
  var globalStore = _ref.globalStore,
      children = _ref.children;

  var _React$useState = react["useState"](globalStore.text.get()),
      _React$useState2 = _slicedToArray(_React$useState, 2),
      localText = _React$useState2[0],
      setLocalText = _React$useState2[1];

  react["useEffect"](function () {
    var setNewTextValue = function setNewTextValue(value) {
      setLocalText(value);
    };

    if (globalStore) {
      globalStore.text.subscribe(setNewTextValue, _this);
    }
  ...
  var setGlobalTextContextValue = react["useMemo"](function () {
    return {
  ...
  return react["createElement"](GetGlobalTextContext.Provider, {
    value: localText
  }, react["createElement"](SetGlobalTextContext.Provider, {
    value: setGlobalTextContextValue
  }, children));
};
// CONCATENATED MODULE: ./common/providers/global-text/global-text.hooks.tsx


var global_text_hooks_useGetGlobalText = function useGetGlobalText() {
  return react["useContext"](GetGlobalTextContext);
};
var global_text_hooks_useSetGlobalText = function useSetGlobalText() {
  return react["useContext"](SetGlobalTextContext);
};
// CONCATENATED MODULE: ./common/providers/global-text/index.ts


// CONCATENATED MODULE: ./text-component.tsx


var text_component_TextComponent = function TextComponent(props) {
  var id = props.id,
      customTitle = props.customTitle;
  var text = global_text_hooks_useGetGlobalText();

  var _useSetGlobalText = global_text_hooks_useSetGlobalText(),
      setText = _useSetGlobalText.setText;

  var handleTextChange = react["useCallback"](function (event) {
  ...
  return react["createElement"]("div", {
    ...
    id: id
  }, react["createElement"]("h1", null, "React Application"), react["createElement"]("h2", null, customTitle), react["createElement"]("textarea", {
    value: text,
...
var app_AppComponent = function AppComponent(props) {
  var id = props.id,
      customTitle = props.customTitle,
      moduleState = props.moduleState;
  return react["createElement"](react["Fragment"], null, react["createElement"](global_text_provider_GlobalTextProvider, {
    globalStore: moduleState
  }, react["createElement"](text_component_TextComponent, {
...
var App = {
  render: function render(props, container) {
    console.log('render props', props);
    react_dom["render"](react["createElement"](app_AppComponent, props), container);
  }
};
